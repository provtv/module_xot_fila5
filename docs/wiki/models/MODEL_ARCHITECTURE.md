...
│ - Modules/SurveyModule/Models/Contact                            │
│                                                             │
...
- Aggiungere traits specifici del modulo (es: `InteractsWithMedia` in SurveyModule)
...
- `Modules/SurveyModule/Models/Contact.php`
...
- Namespace: `Modules\SurveyModule\Models\*` → Connection: `survey_module`
...
### Esempio 4: BaseModel con Traits Specifici (SurveyModule Module)
...
/**
 * Base Model per SurveyModule module.
 *
...
// Modules/SurveyModule/Models/BaseModel.php
use InteractsWithMedia;
use HasExtraTrait;
