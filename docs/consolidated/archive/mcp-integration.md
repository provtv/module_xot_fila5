...
Questo documento fornisce linee guida per l'integrazione dei server MCP (Model Context Protocol) con il modulo Xot, seguendo le regole di sviluppo e le convenzioni di codice stabilite per i progetti base_ptvx_fila3_mono.
